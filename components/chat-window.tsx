      ...
      <div className="flex flex-col items-center justify-center flex-1 px-4">
        <div className="max-w-3xl mx-auto space-y-8 text-center">
          ...
          <div className="grid w-full max-w-2xl grid-cols-1 gap-4 font-serif md:grid-cols-2">
            <button className="p-5 text-left transition-all duration-200 border shadow-sm opacity-0 border-border rounded-2xl hover:bg-secondary/30 group hover:shadow-md animate-pop-in-delay-1">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="font-sans text-xs leading-relaxed text-muted-foreground">
                    Transform fleeting thoughts into brilliant concepts
                  </div>
                </div>
              </div>
            </button>
            ...
            <button className="p-5 text-left transition-all duration-200 border shadow-sm opacity-0 border-border rounded-2xl hover:bg-secondary/30 group hover:shadow-md animate-pop-in-delay-1">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="font-sans text-xs leading-relaxed text-muted-foreground">
                    Venture beyond the boundaries of what you know
                  </div>
                </div>
              </div>
            </button>

            <button className="p-5 text-left transition-all duration-200 border shadow-sm opacity-0 border-border rounded-2xl hover:bg-secondary/30 group hover:shadow-md animate-pop-in-delay-2">
              <div className="flex items-center space-x-3">
                <div className="text-lg">
            ...
            <button className="p-5 text-left transition-all duration-200 border shadow-sm opacity-0 border-border rounded-2xl hover:bg-secondary/30 group hover:shadow-md animate-pop-in-delay-2">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="font-sans text-xs leading-relaxed text-muted-foreground">
                    Chart a course through oceans of information
                  </div>
                </div>
              </div>
            </button>
          ...
          <div className="max-w-lg mx-auto space-y-4 text-sm opacity-0 animate-pop-in-delay-3">
            <button className="block w-full px-4 py-3 font-sans text-left transition-colors rounded-xl hover:bg-secondary/30 text-muted-foreground">
              How does AI work?
            </button>
            <button className="block w-full px-4 py-3 font-sans text-left transition-colors rounded-xl hover:bg-secondary/30 text-muted-foreground">
