...
const OPENAI_CAPABILITIES: Record<SupportedOpenAIModelId, ModelCapabilities> = {
  'gpt-4o': { thinking: false, image: true, tool: true, streaming: true, contextWindow: 128000 },
  'gpt-4o-mini': { thinking: false, image: true, tool: true, streaming: true, contextWindow: 128000 },
  'gpt-4-turbo': { thinking: false, image: true, tool: true, streaming: true, contextWindow: 128000 },
  'gpt-4': { thinking: false, image: false, tool: true, streaming: true, contextWindow: 8192 },
  'gpt-3.5-turbo': { thinking: false, image: false, tool: true, streaming: true, contextWindow: 16385 }
};

const ANTHROPIC_CAPABILITIES: Record<SupportedAnthropicModelId, ModelCapabilities> = {
  'claude-3-5-sonnet-20241022': { thinking: true, image: true, tool: true, streaming: true, contextWindow: 200000 },
  'claude-3-5-haiku-20241022': { thinking: false, image: true, tool: true, streaming: true, contextWindow: 200000 },
  'claude-3-opus-20240229': { thinking: false, image: true, tool: true, streaming: true, contextWindow: 200000 },
  'claude-3-sonnet-20240229': { thinking: false, image: true, tool: true, streaming: true, contextWindow: 200000 },
  'claude-3-haiku-20240307': { thinking: false, image: true, tool: true, streaming: true, contextWindow: 200000 }
};

const GOOGLE_CAPABILITIES: Record<SupportedGoogleModelId, ModelCapabilities> = {
  'gemini-1.5-pro': { thinking: false, image: true, tool: true, streaming: true, contextWindow: 2000000 },
  'gemini-1.5-flash': { thinking: false, image: true, tool: true, streaming: true, contextWindow: 1000000 },
  'gemini-pro': { thinking: false, image: false, tool: true, streaming: true, contextWindow: 32768 },
  'gemini-pro-vision': { thinking: false, image: true, tool: false, streaming: true, contextWindow: 16384 }
};

const GROK_CAPABILITIES: Record<SupportedGrokModelId, ModelCapabilities> = {
  'grok-beta': { thinking: false, image: false, tool: true, streaming: true, contextWindow: 131072 },
  'grok-2': { thinking: false, image: true, tool: true, streaming: true, contextWindow: 131072 }
};

const OPENROUTER_CAPABILITIES: Record<SupportedOpenRouterModelId, ModelCapabilities> = {
  'openai/gpt-4o': { thinking: false, image: true, tool: true, streaming: true, contextWindow: 128000 },
  'anthropic/claude-3.5-sonnet': { thinking: true, image: true, tool: true, streaming: true, contextWindow: 200000 },
  'meta-llama/llama-3.1-405b-instruct': { thinking: false, image: false, tool: true, streaming: true, contextWindow: 131072 },
  'google/gemini-pro-1.5': { thinking: false, image: true, tool: true, streaming: true, contextWindow: 2000000 },
  'mistralai/mixtral-8x7b-instruct': { thinking: false, image: false, tool: true, streaming: true, contextWindow: 32768 }
};
...
export const getModelCapabilities = (provider: AIProvider, modelId: string): ModelCapabilities | null => {
  const models = providerModels[provider];
  return models?.find(m => m.id === modelId)?.capabilities || null;
};

// Type guards for runtime validation
export const isValidModelId = (provider: AIProvider, modelId: string): boolean => {
  const models = providerModels[provider];
